...
class Product(models.Model):
    ...
    local_image = models.CharField(max_length=255, blank=True, null=True, help_text='Local image path under static/img/boycott/')
...
class Alternative(models.Model):
    ...
    description = models.TextField(blank=True)
    image_url = models.URLField(blank=True)
    local_image = models.CharField(max_length=255, blank=True, null=True, help_text='Local image path under static/img/alternative/')
